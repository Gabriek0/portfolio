export const AboutMeData =
    `Meu nome é Gabriel Henrique, tenho 20 anos. Estou no último ano de graduação
    em Análise e Desenvolvimento de Sistemas. Desde pequeno sou apaixonado por técnologia
    e impressionado no quão poderosa ela pode ser para mudar, automatizar e impactar positivamente
    na vida das pessoas. Atualmente, estudo desenvolvimento web, utilizando tecnologias como: HTML, CSS
    Javascript, Typescript, Reactjs e Nextjs. Estou sempre em busca de novos desafios e gosto de aprender
    novas habilidades.`
...
export const projectList = {
    ...
    dtMoneyGif: {
        ...
        description: `O dt money, é uma plataforma de controle financeiro 
